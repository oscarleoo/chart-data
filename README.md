...
| Sixty-five years of vanishing births | [`vanishing-births.csv`](vanishing-births/vanishing-births.csv) | World Bank, World Development Indicators, total fertility rate (SP.DYN.TFRT.IN), 1960-2024, all 159 countries with at least 1M people; chart auto-refreshes weekly from the chart-data CSV |
